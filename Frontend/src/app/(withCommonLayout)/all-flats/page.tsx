...
import { SkeletonCard } from "@/components/ui/LoadingCard/CardSkeleton";
...
function AllFlatPage() {
  ...
  return (
    <section className=" mx-auto">
      <PageSectionTitle heading="Flat is here..." />
      ...
      {!isLoading ? (
        <>
          <div
            data-aos="fade-up"
            className="grid grid-cols-1 sm:grid-cols-2 mt-12 lg:grid-cols-3 xl:grid-cols-3 gap-6 w-full mx-auto sm:px-4 px-6 mb-6 container"
          >
            {data &&
              data?.map((item: any) => (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 mt-12 lg:grid-cols-3 xl:grid-cols-3 gap-6 w-full mx-auto sm:px-4 px-6 mb-6 container">
          {[...Array(6)].map((_, index) => (
