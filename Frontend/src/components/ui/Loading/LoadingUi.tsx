...
function LoadingUi() {
  return (
    <section className=" h-screen  bg-gradient-to-r from-[#000018] to-[#010524] relative  flex justify-center items-center flex-col overflow-hidden mx-auto sm:px-10 px-5">
      <svg
        height="108px"
        width="108px"
        viewBox="0 0 128 128"
