...
function ExploreAllFlat() {
  ...
  return (
    <section className="">
      <HomeSectionTitle
        mainTitle="Showcase Your Own Destination"
        subTitle="Wah!!! have a more chill life gooing.."
      />

      {!isLoading ? (
        <div
          data-aos="fade-down"
          className="grid grid-cols-1 sm:grid-cols-2 mt-16 lg:grid-cols-3 xl:grid-cols-3 gap-6 w-full mx-auto sm:px-4 px-6 mb-6"
        >
              ...
              <div className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-1 w-full">
                <div className="shadow-md border border-gray-300 border-dashed p-4 rounded-lg bg-white">
                  <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                    ...
                    <div className="absolute flex justify-center bottom-0 mb-3">
                      <div className="flex bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow">
                        <p className="flex items-center font-medium text-gray-800">
                          ...
                          {item?.totalRooms} + {item?.totalBedrooms}
                        </p>
                    ...
                    <span className="absolute font-poppins top-0 left-0 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 bg-orange-500 text-sm font-medium text-white select-none">
                      Featured
                    </span>
                  </div>

                  <div className="mt-4 ">
                    <p className="mt-2 font-Kanit text-xs sm:text-base text-gray-900 line-clamp-1 flex gap-2 items-center">
                      {item?.location}{" "}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                  ...
                  <div className="grid grid-cols-2 grid-rows-2 mt-4">
                    <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                      ...
                      <span className="mt-2 xl:mt-0">Flat & Room</span>
                    </p>
                    <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                      <svg
                        className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                    ...
                    <p className="inline-flex xl:flex-row xl:items-center text-gray-800">
                      <svg
                        className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512"
                      ...
                      <span className="mt-2 xl:mt-0 font-poppins text-sm">
                        Advanced: {item?.advanceAmount}৳
                      </span>
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-6">
                    <div className="flex items-center">
                      <Link href={`/flatDetails/${item?.id}`}>
                        <button className=" font-poppins   inline-flex px-2 py-2 text-xs sm:px-3 sm:py-2 rounded-lg bg-black sm:text-sm font-medium text-white select-none">
                          Details
                        </button>
                      </Link>
                    </div>
                    ...
                    <div className="flex justify-end">
                      <p className="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
                        ...
                        <span className="sm:text-xl text-lg font-poppins">
                          {item?.rent}
                        </span>
                        /m
                      </p>
        ...
        <div
          data-aos="fade-up"
          className="md:px-4 md:grid md:grid-cols-3 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0 px-4"
        >
          {[...Array(6)].map((_, index) => (
      ...
      <Link
        ...
        href={`/all-flats`}
      >
        <button className="flex items-center mt-4 sm:px-4 sm:py-3 px-3 py-2 bg-black text-white text-xs sm:text-sm uppercase font-medium rounded-md duration-300 active:scale-90 focus:outline-none ">
