        ...
        {items.map((item, idx) => (
          <li
            ...
            className="w-[90vw] max-w-full relative rounded-2xl border 
             flex-shrink-0 border-slate-700 p-5 md:p-16 md:w-[60vw] "
            style={{
              //   background:
          ...
          >
            <blockquote>
              ...
              <span className=" relative z-20 text-base md:text-lg leading-[1.6] text-gray-200 font-normal font-Rubik">
                {item.quote}
              </span>
              <div className="relative z-20 mt-8 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  {/* change text color, font-normal to font-bold, text-xl */}
                  <span className="sm:text-xl text-lg font-Raleway font-bold leading-[1.2] text-gray-300">
                    {item.name}
                  </span>
                  {/* change text color */}
                  <span className=" text-sm leading-[1.2] text-gray-400 font-normal font-Poppins">
                    {item.title}
                  </span>
                </span>
              </div>
